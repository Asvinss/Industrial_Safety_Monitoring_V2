...
const NavigationHeader = ({ user, alertCount = 0, onNavigate }) => {
  ...
  const navigationItems = [
    {
      label: 'Live Monitor',
      path: '/live-monitoring-dashboard',
      icon: 'Monitor',
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-[1000] bg-card border-b border-border">
      <div className="flex items-center justify-between h-[60px] px-4 lg:px-6">
        ...
        {/* Right Side Actions */}
        <div className="flex items-center space-x-3">
          <AlertNotificationBadge count={alertCount} onAlertClick={() => handleNavigation('/live-monitoring-dashboard')} />
