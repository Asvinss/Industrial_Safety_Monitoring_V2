...
const FilterPanel = ({ isCollapsed, onToggleCollapse, filters, onFiltersChange }) => {
  ...
  const shiftPatterns = [
    { id: 'morning', label: 'Morning Shift (6AM-2PM)', count: 156 },
    { id: 'afternoon', label: 'Afternoon Shift (2PM-10PM)', count: 189 },
    { id: 'night', label: 'Night Shift (10PM-6AM)', count: 78 },
    { id: 'weekend', label: 'Weekend', count: 45 }
  ];
