        ...
        <table className="w-full">
          <thead className="bg-muted/50 border-b border-border">
            <tr>
              ...
              <th className="text-left px-4 py-3 font-semibold text-foreground">Investigator</th>
              <th className="w-24 px-4 py-3 font-semibold text-foreground">Actions</th>
            </tr>
          </thead>
          <tbody>
                ...
                <React.Fragment key={violation?.id}>
                  <tr className={`border-b border-border hover:bg-muted/30 transition-colors ${isSelected ? 'bg-accent/10' : ''}`}>
                    <td className="px-4 py-3">
                      <Checkbox
                        checked={isSelected}
                        onChange={(e) => handleRowSelect(violation?.id, e?.target?.checked)}
                      />
                    </td>
                    <td className="px-4 py-3">
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm text-foreground">{violation?.investigator || 'Unassigned'}</span>
                      </div>
                    </td>
                    <td className="px-4 py-3">
